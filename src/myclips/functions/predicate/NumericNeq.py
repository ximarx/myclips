...
class NumericNeq(Function):
    '''
    The <> function returns the symbol TRUE if its first argument is not equal in value to all its subsequent arguments, 
    ...
    @see: http://www.comp.rgu.ac.uk/staff/smc/teaching/clips/vol1/vol1-12.1.html#Heading209
    '''
...
NumericNeq.DEFINITION = FunctionDefinition("?SYSTEM?", "<>", NumericNeq(), types.Symbol, NumericNeq.do ,
            [
