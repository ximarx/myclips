...
class LessThan(Function):
    '''
    The < function returns the symbol TRUE if for all its arguments, argument n- 1 is less than argument n, 
    ...
    @see: http://www.comp.rgu.ac.uk/staff/smc/teaching/clips/vol1/vol1-12.1.html#Heading212
    '''
...
LessThan.DEFINITION = FunctionDefinition("?SYSTEM?", "<", LessThan(), types.Symbol, LessThan.do ,
            [
