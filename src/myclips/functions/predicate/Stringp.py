...
class Stringp(_TypeTesting):
    '''
    The stringp function returns the symbol TRUE if its argument is a String, otherwise it returns the symbol FALSE.
    @see: http://www.comp.rgu.ac.uk/staff/smc/teaching/clips/vol1/vol1-12.1.html#Heading190
    '''
    pass
        
        
Stringp.DEFINITION = FunctionDefinition("?SYSTEM?", "stringp", Stringp(types.String), types.Symbol, Stringp.do ,
            [
