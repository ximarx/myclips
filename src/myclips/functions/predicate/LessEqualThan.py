...
class LessEqualThan(Function):
    '''
    The <= function returns the symbol TRUE if for all its arguments, argument n- 1 is less than or equal to argument n, 
    ...
    @see: http://www.comp.rgu.ac.uk/staff/smc/teaching/clips/vol1/vol1-12.1.html#Heading213
    '''
...
LessEqualThan.DEFINITION = FunctionDefinition("?SYSTEM?", "<=", LessEqualThan(), types.Symbol, LessEqualThan.do ,
            [
